...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contribuyente.id_contrato'
        db.alter_column(u'contribuyentes_contribuyente', 'id_contrato', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Contribuyente.id_contrato'
        raise RuntimeError("Cannot reverse this migration. 'Contribuyente.id_contrato' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Contribuyente.id_contrato'
        db.alter_column(u'contribuyentes_contribuyente', 'id_contrato', self.gf('django.db.models.fields.IntegerField')(unique=True))
