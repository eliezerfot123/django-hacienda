...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Credito.impuesto'
        db.add_column(u'contribuyentes_credito', 'impuesto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['liquidaciones.Impuesto']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Credito.impuesto'
        db.delete_column(u'contribuyentes_credito', 'impuesto_id')
    ...
    models = {
        ...
        u'contribuyentes.credito': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'impuesto': ('django.db.models.fields.related.ForeignKey', [], {'default': '2', 'to': u"orm['liquidaciones.Impuesto']"}),
