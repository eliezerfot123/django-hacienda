...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Monto'
        db.create_table(u'contribuyentes_monto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contribuyente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contribuyentes.Contribuyente'])),
            ('estimado', self.gf('django.db.models.fields.FloatField')()),
            ('definitivo', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('rubro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contribuyentes.Rubro'])),
        ))
        db.send_create_signal(u'contribuyentes', ['Monto'])


    def backwards(self, orm):
        # Deleting model 'Monto'
        db.delete_table(u'contribuyentes_monto')
