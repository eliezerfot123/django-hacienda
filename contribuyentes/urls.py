...
from contribuyentes.views import LiquidacionWizard, ContribuyenteCrear, ContribuyenteEditar,actividad_eco,definitiva,estimada
...
urlpatterns = patterns('',
    ...
    url(r'crear_pago/$', login_required(LiquidacionWizard.as_view([ ImpuestosForm, TipoLiqEconomica, RubrosForm,EstimadasForm, LiquidacionForm],condition_dict={'1':actividad_eco,'2':definitiva,'3':estimada}), login_url='/login/'), name="cargar-liquid"),
