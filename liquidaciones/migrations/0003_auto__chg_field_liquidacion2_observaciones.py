...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Liquidacion2.observaciones'
        db.alter_column(u'liquidaciones_liquidacion2', 'observaciones', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Liquidacion2.observaciones'
        raise RuntimeError("Cannot reverse this migration. 'Liquidacion2.observaciones' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Liquidacion2.observaciones'
        db.alter_column(u'liquidaciones_liquidacion2', 'observaciones', self.gf('django.db.models.fields.CharField')(max_length=200))
