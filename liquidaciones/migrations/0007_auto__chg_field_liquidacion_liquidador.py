...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Liquidacion.liquidador'
        db.alter_column(u'liquidaciones_liquidacion', 'liquidador_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Liquidacion.liquidador'
        raise RuntimeError("Cannot reverse this migration. 'Liquidacion.liquidador' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Liquidacion.liquidador'
        db.alter_column(u'liquidaciones_liquidacion', 'liquidador_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
