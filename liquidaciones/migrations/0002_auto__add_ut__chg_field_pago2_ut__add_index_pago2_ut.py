...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UT'
        db.create_table(u'liquidaciones_ut', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ano', self.gf('django.db.models.fields.IntegerField')()),
            ('valor', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'liquidaciones', ['UT'])
        # Renaming column for 'Pago2.ut' to match new field type.
        db.rename_column(u'liquidaciones_pago2', 'ut', 'ut_id')
        # Changing field 'Pago2.ut'
        db.alter_column(u'liquidaciones_pago2', 'ut_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['liquidaciones.UT']))
        # Adding index on 'Pago2', fields ['ut']
        db.create_index(u'liquidaciones_pago2', ['ut_id'])


    def backwards(self, orm):
        # Removing index on 'Pago2', fields ['ut']
        db.delete_index(u'liquidaciones_pago2', ['ut_id'])

        # Deleting model 'UT'
        db.delete_table(u'liquidaciones_ut')


        # Renaming column for 'Pago2.ut' to match new field type.
        db.rename_column(u'liquidaciones_pago2', 'ut_id', 'ut')
        # Changing field 'Pago2.ut'
        db.alter_column(u'liquidaciones_pago2', 'ut', self.gf('django.db.models.fields.IntegerField')())
