...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pago2.tipo'
        db.add_column(u'liquidaciones_pago2', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='SND', max_length=3),
                      keep_default=False)
        db.execute('UPDATE liquidaciones_pago2 SET tipo=liquidaciones_liquidacion2.tipo FROM liquidaciones_liquidacion2 WHERE liquidaciones_liquidacion2.id=liquidaciones_pago2.liquidacion_id')


        # Deleting field 'Liquidacion2.tipo'
        db.delete_column(u'liquidaciones_liquidacion2', 'tipo')


    def backwards(self, orm):
        # Adding field 'Liquidacion2.tipo'
        db.add_column(u'liquidaciones_liquidacion2', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='SND', max_length=3),
                      keep_default=False)
        db.execute('UPDATE liquidaciones_liquidacion2 SET tipo=liquidaciones_pago2.tipo FROM liquidaciones_pago2 WHERE liquidaciones_liquidacion2.id=liquidaciones_pago2.liquidacion_id')
        # Deleting field 'Pago2.tipo'
        db.delete_column(u'liquidaciones_pago2', 'tipo')
