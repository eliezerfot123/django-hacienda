...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pago2.credito_fiscal'
        db.add_column(u'liquidaciones_pago2', 'credito_fiscal',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pago2.credito_fiscal'
        db.delete_column(u'liquidaciones_pago2', 'credito_fiscal')
